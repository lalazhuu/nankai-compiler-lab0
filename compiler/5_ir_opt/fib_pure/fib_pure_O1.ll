; ModuleID = 'source/fib_pure.cpp'
source_filename = "source/fib_pure.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_fib_pure.cpp, i8* null }]
...
41:                                               ; preds = %32, %35
  ...
  %43 = call noundef nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZNSo3putEc(%"class.std::basic_ostream"* noundef nonnull align 8 dereferenceable(8) %15, i8 noundef signext %42)
...
define internal void @_GLOBAL__sub_I_fib_pure.cpp() #6 section ".text.startup" {
