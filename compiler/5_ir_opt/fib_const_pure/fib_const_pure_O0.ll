...
18:                                               ; preds = %7
  ...
  %20 = call noundef nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZNSolsEi(%"class.std::basic_ostream"* noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef %19)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_fib_const_pure.cpp() #0 section ".text.startup" {
