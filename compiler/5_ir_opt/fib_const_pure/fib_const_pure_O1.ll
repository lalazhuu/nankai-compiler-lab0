; ModuleID = 'source/fib_const_pure.cpp'
source_filename = "source/fib_const_pure.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_fib_const_pure.cpp, i8* null }]
...
define dso_local noundef i32 @main() local_unnamed_addr #3 {
  %1 = call noundef nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZNSolsEi(%"class.std::basic_ostream"* noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef 55)
...
21:                                               ; preds = %14
  call void @_ZNKSt5ctypeIcE13_M_widen_initEv(%"class.std::ctype"* noundef nonnull align 8 dereferenceable(570) %11)
  ...
  %26 = call noundef signext i8 %25(%"class.std::ctype"* noundef nonnull align 8 dereferenceable(570) %11, i8 noundef signext 10)
  br label %27

27:                                               ; preds = %18, %21
  %28 = phi i8 [ %20, %18 ], [ %26, %21 ]
  %29 = call noundef nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZNSo3putEc(%"class.std::basic_ostream"* noundef nonnull align 8 dereferenceable(8) %1, i8 noundef signext %28)
  %30 = call noundef nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZNSo5flushEv(%"class.std::basic_ostream"* noundef nonnull align 8 dereferenceable(8) %29)
  ret i32 0
}
...
define internal void @_GLOBAL__sub_I_fib_const_pure.cpp() #5 section ".text.startup" {
